...
Unittest classes:
    TestHBNBCommand_ypromptingg
    TestHBNBCommand_yhelpp
    TestHBNBCommand_yexitt
    TestHBNBCommand_ycreatee
    TestHBNBCommand_yshoww
    TestHBNBCommand_yalll
    TestHBNBCommand_ydestroyy
    TestHBNBCommand_yupdatee
"""
import os
import sys
import unittest
...
class TestHBNBCommand_ypromptingg(unittest.TestCase):
    """Unittestss testprompting of HBNB ycommand interpreter."""
...
class TestHBNBCommand_yhelpp(unittest.TestCase):
...
class TestHBNBCommand_yexitt(unittest.TestCase):
...
class TestHBNBCommand_ycreatee(unittest.TestCase):
...
class TestHBNBCommand_yshoww(unittest.TestCase):
...
class TestHBNBCommand_ydestroyy(unittest.TestCase):
...
class TestHBNBCommand_yalll(unittest.TestCase):
...
class TestHBNBCommand_yupdatee(unittest.TestCase):
