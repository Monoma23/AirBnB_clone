...
class TestPlace_Sinstantiationn(unittest.TestCase):
    """Unittests testing instantiations of Pslace class."""
...
class TestPlace_Ssavee(unittest.TestCase):
...
class TestPlace_to_Sdictt(unittest.TestCase):
