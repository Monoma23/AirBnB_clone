...
class TestUser_yinstantiationn(unittest.TestCase):
...
class e(unittest.TestCase):
    """Unittests test save method sof class."""
...
class TestUser_to_ydict(unittest.TestCase):
    """Unittests testsing to_dict method User class."""
