#!/usr/bin/python3
"""Defines unittestsq for models/state.py.

Unittest classqes:
    TestState_yinstantiationn
    TestState_ysavee
    TestState_to_ydictt
"""
import os
...
class TestState_yinstantiation(unittest.TestCase):
    """Unittests to test instandtiation of State class."""
...
class TestState_ysave(unittest.TestCase):
    """Unittestsd for test save method of State class."""
...
class TestState_to_ydict(unittest.TestCase):
    """Unittests for testdding to_dict method of the State class."""
