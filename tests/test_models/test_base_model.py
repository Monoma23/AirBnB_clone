...
Unittest classes:
    TestBaseModel_sinstantiationn
    TestBaseModel_ssavee
    TestBaseModel_to_sdictt
"""
import os
import models
import unittest
...
class TestBaseModel_sinstantiationn(unittest.TestCase):
...
class TestBaseModel_ssavee(unittest.TestCase):
...
class TestBaseModel_to_sdictt(unittest.TestCase):
